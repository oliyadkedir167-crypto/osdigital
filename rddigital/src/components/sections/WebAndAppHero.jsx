...
import Hero, { GoogleRating } from './Hero';
        ...
        <Hero
            ...
            bgContent={
                <div className="absolute inset-0 w-full h-full">
                    <div className="block absolute inset-0 w-full h-full bg-[#F5F5F5] bg-[url(/images/hex-background-networking.jpg)] opacity-[15%] bg-cover pb-16 bg-center"></div>
                </div>
            }
            ...
            description="We Build Custom Apps That Support Your Day-To-Day Operations. If You Need Tools For Your Team, We'll Design And Develop Apps That Are Easy To Use, Fast To Load, And Built Around Your Process."
            ...
            rightContent={
                <div className="relative h-[20rem] md:h-[30rem] mt-8 lg:mt-0 xl:h-[40rem] w-full flex justify-center lg:justify-end items-center">
                    <img loading="lazy" src="https://rd-cms.do.recognisedesign.com/uploads/Group_1000004228_6be0032836.webp" alt="Web and Mobile Apps mockup" className="object-contain h-full w-full lg:w-[120%] xl:w-[130%] lg:absolute lg:right-0 xl:-right-8 z-30" title="Web and Mobile Apps Mockup" />
                </div>
            }
            bottomContent={null}
